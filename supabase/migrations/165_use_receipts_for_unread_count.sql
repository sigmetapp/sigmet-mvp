...
-- Fix unread count to use message receipts status instead of last_read_message_id
-- This ensures accurate counting based on message delivery/read status
...
unread_receipts as (
  ...
  where r.user_id::uuid = p_user_id
    and msg.deleted_at is null
    and msg.sender_id::uuid <> p_user_id
