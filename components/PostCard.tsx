...
export default function PostCard({
  ...
  const defaultContent = (
    <div className="relative z-10 flex flex-col gap-2">
      ...
      <p className="whitespace-pre-wrap text-sm leading-6 text-slate-700 dark:text-slate-300 break-words">{formatTextWithMentions(post.content, post.id ? parseInt(post.id, 10) : undefined)}</p>
