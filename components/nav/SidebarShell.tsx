...
export default function SidebarShell({ user, children }: { user: User; children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen w-full overflow-x-hidden transition-colors ${
      isLight ? "bg-primary-gradient text-primary-text" : "bg-sigmet text-primary-text"
    }`}>
      {/* Mobile top bar removed */}

      <div className="mx-auto flex w-full max-w-[1088px]">
        {/* Desktop sidebar */}
        ...
        <main
          ...
          className={`min-h-screen flex-1 w-full min-w-0 px-4 pt-4 pb-24 lg:pb-6 lg:px-8 lg:py-6 lg:pt-6 transition-colors relative z-0 overflow-x-hidden ${
